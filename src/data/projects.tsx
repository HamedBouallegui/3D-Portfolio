...
const PROJECT_SKILLS = {
  ...
  ios: {
    ...
    bg: "black",
    fg: "white",
    icon: <SiApple />, // using Apple icon to represent iOS
  },
  android: {
    title: "Android",
    bg: "black",
...
const projects: Project[] = [
  ...
  { // 02. FinanceMe project
    ...
    live: "https://github.com/HamedBouallegui/Car_Wash",
    github: "https://github.com/HamedBouallegui/Car_Wash",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/CarWash/WhatsApp Image 2025-09-30 à 20.53.31_294e32b9.jpg`,
              `${BASE_PATH}/CarWash/Screenshot 2025-09-30 213239.png`,
              `${BASE_PATH}/CarWash/WhatsApp Image 2025-09-30 à 20.53.32_1bcd1053.jpg`,
  ...
  { // 04. Smart parking assitant
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            📚 Library Management System: An application that helps manage books, members, and loans in a library.
            A application that helps manage books, members, and loans in a library.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/Library/Screenshot 2025-10-30 125058.png`,
              `${BASE_PATH}/Library/Screenshot 2025-10-30 125315.png`,
              `${BASE_PATH}/Library/Screenshot 2025-10-30 125454.png`,
            ]}
          />
        </div>
      );
