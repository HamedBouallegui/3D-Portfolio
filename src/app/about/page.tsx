...
const CONTACT_LINKS = [
  ...
  },
  {
    name: "Phone",
    content: "+21650281701",
    href: "tel:+21650281701",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/hamed-bouallegui-0320b0288/",
    content: "hamed-bouallegui-0320b0288",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/HamedBouallegui",
    content: "/HamedBouallegui",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Hamed Bouallegui</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Hamed Bouallagui, a passionate Web Developer from Sidi Bouzid, Tunisia.
              Currently in my final year of a Bachelor’s degree in Web Development at ISET Sidi Bouzid, I enjoy building modern web and mobile applications that combine functionality and clean design.
              With hands-on experience in Angular, Flutter, Spring Boot, and Node.js, I specialize in creating full-stack solutions that deliver great user experiences.
            </p>
            <p className="mb-10">
