...
const PROJECTS = [
  {
    ...
    description: `A full-stack web application for booking doctor appointments online, featuring an integrated AI chatbot assistant that helps users find doctors, schedule appointments, and get quick answers. Built using Angular, Node.js, and MongoDB.`,
    link: "https://hamedbouallegui.github.io/Doctor_Appointment/",
    images: [
      "/assets/projects-screenshots/Doctor-appointment/Screenshot 2025-10-31 151518.png",
      "/assets/projects-screenshots/Doctor-appointment/Screenshot 2025-10-31 151723.png",
    ],
  },
  {
    id: 2,
